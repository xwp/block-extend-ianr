...
const name = 'xwp-wp-test/xwp-block-extend';
		...
		return (
			<>
				...
				<RichText
					identifier="content"
					tagName="p"
					className={ classnames( 'xwp-block-extend', className, {
					...
					aria-label={
						content ?
							__( 'XWP Paragraph block' ) :
							__(
								'Empty XWP block; start writing or type forward slash to choose a block'
							  )
					}
					placeholder={
						placeholder ||
						__( 'Start writing or type / to choose a (preferably XWP) block' )
					}
